...
class AnunciosDAO
{
    ...
    public function venderAnuncio($idAnuncio, $idUsuario)
    {
        // Construimos la consulta SQL para actualizar solo las columnas necesarias
        $sql = "UPDATE anuncios SET vendido=1, idComprador=? WHERE id=?";
        ...
        // Vinculamos los parámetros
        $stmt->bind_param("si", $idUsuario, $idAnuncio);
