...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Recojo datos del formulario y los limpio
    ...
    if ($usuario && password_verify($password, $usuario->getPassword())) {
        ...
        // Email y contraseña correctos. Iniciamos sesión
            ...
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        ...
                        <p>Introduce tus datos para loguearte</p>
                    </div>
                    ...
                    <form action="login.php" method="post"> <!-- Formulario -->
                            ...
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        placeholder="josemartin@example.com">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button type="submit"
                                    class="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white rounded-lg px-3 py-3 font-semibold">LOGIN</button>
                            </div>
                        </div>
