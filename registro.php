                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    ...
                    <form action="registro.php" method="post"> <!-- Formulario -->
                            ...
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input name="telefono" type="number"
                                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                        placeholder="620089213" value="<?= $telefono ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input name="poblacion" type="text"
                                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                        placeholder="Tomelloso" value="<?= $poblacion ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input name="email" type="email"
                                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                        placeholder="josemartin@example.com" value="<?= $email ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button
                                    class="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTRATE
                                    AHORA</button>
                            </div>
                        </div>
                    </form>
